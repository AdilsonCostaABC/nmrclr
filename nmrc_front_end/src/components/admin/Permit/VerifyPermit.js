...
function VerifyPermit(props){
    
    const [modalIsOpen, setModalIsOpen] = useState(false);
    const [loading, setloading] = useState(true);
    const history=useHistory();
    const [permitNotVerifiedInput, setpermitNotVerifiedInput] = useState([]);
    const [error, setError] = useState([]);
     ...
     useEffect(() => {
        ...
        axios.get(`/api/verify-permit/${permit_id}`).then(res=>{
            console.log(res.data.region);
            if (res.data.status===200) {
                setpermitNotVerifiedInput(res.data.verify_permit);
            }
     ...
     const handleInput=(e)=>{
        ...
        e.persist();
        setpermitNotVerifiedInput({...permitNotVerifiedInput,[e.target.name]:e.target.value});
    }
    ...
    const updatePermitNotVerified=(e)=>{
        ...
        //taking id from parameter/url after click edit
         const permit_id=props.match.params.id;
         const data=permitNotVerifiedInput;
    ...
    const submitPermitForApproval=(e)=>{
        //to stop the page reload
        e.preventDefault();
        //taking id from parameter/url after click edit
         const permit_id=props.match.params.id;
         const data=permitNotVerifiedInput;
        //sending the data to api
        axios.put(`/api/submit-permit-for-approval/${permit_id}`,data).then(res=>{
            if (res.data.status===200) {
                swal("Success",res.data.message,"success");
                setError([]);
                history.push('/admin/view-permit-not-verified');
    ...
    if (loading) {
        return <h4>Loading  Verify Permit...</h4>
    }
    return (
        <div className="container-fluid px-4 py-0">
            ...
            <div className="card mt-4">
                <div className="card-header bg-danger">
                    <h4 className="text-white">Verify Permit
                    <Link style={{ textDecoration: 'none' }} to="/admin/view-permit-not-verified" className="float-end">
                        <Button
                            type=""
                            fullWidth
                            variant="contained"
                ...
                <div className="card-body">
                    <form onSubmit={updatePermitNotVerified}>
                        <div className="tab-content" id="myTabContent">
                            ...
                            <div className="col-md-3 form-group mb-3">
                                                    {/* <FormControl variant="standard" sx={{ mt:-3, minWidth: 290 }}>
                                                        <TextField
                                                            ...
                                                            value={permitNotVerifiedInput.check_digit}
                                                            color="warning"
                                                            margin="normal"
                                                            required
                                                            fullWidth
                                                    ...
                                                    {/* <span className="text-danger">{permitNotVerifiedInput.error_list.check_digit}</span> */}
                                                    ...
                                                    <FormControl variant="standard" sx={{ mt:1,minWidth: 290 }}>
                                                            ...
                                                            <Select
                                                                ...
                                                                name="comp_id"
                                                                type="text"
                                                                value={permitNotVerifiedInput.comp_id}
                                                                onChange={handleInput}
                                                                label="Company"
                                                                color="warning"
                                                                margin="normal"
                                                        ...
                                                        {/* <span className="text-danger">{permitNotVerifiedInput.error_list.comp_id}</span> */}
                                                    </FormControl>
                                                    <FormControl variant="standard" sx={{ mt:4, minWidth: 290 }}>
                                                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                                                ...
                                                                {/* <span className="text-danger">{permitNotVerifiedInput.error_list.valid_from}</span> */}
                                                    ...
                                                    <FormControl variant="standard" sx={{mt:3,minWidth: 290}}>
                                                        ...
                                                        name="purpose_use"
                                                        type="text"
                                                        value={permitNotVerifiedInput.purpose_use}
                                                        onChange={handleInput}
                                                        />
                                                     </FormControl>    
                                            </div>
                                            ...
                                            <div className="col-md-3 form-group mb-3">
                                                    {/* <FormControl variant="standard" sx={{ mt:-3,ml:9.5, minWidth: 290 }}>
                                                        <TextField
                                                            ...
                                                            name="permit_no"
                                                            onChange={handleInput}
                                                            value={permitNotVerifiedInput.permit_no}
                                                            color="warning"
                                                            margin="normal"
                                                            required
                                                            fullWidth
                                                    ...
                                                    {/* <span className="text-danger">{permitNotVerifiedInput.error_list.permit_no}</span> */}
                                                    ...
                                                    <FormControl variant="standard" sx={{ ml:10,mt:1,minWidth: 290 }}>
                                                            ...
                                                            <Select
                                                                ...
                                                                name="sup_id"
                                                                type="text"
                                                                value={permitNotVerifiedInput.sup_id}
                                                                onChange={handleInput}
                                                                label="Supplier"
                                                                color="warning"
                                                                margin="normal"
                                                        ...
                                                        {/* <span className="text-danger">{permitNotVerifiedInput.error_list.sup_id}</span> */}
                                                    </FormControl>
                                                    ...
                                                    <FormControl variant="standard" sx={{ ml:10,mt:4, minWidth: 290 }}>
                                                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                                                ...
                                                                {/* <span className="text-danger">{permitNotVerifiedInput.error_list.valid_to}</span> */}
                                            ...
                                            <div className="col-md-3 form-group mb-3">
                                                    ...
                                                    <FormControl variant="standard" sx={{mt:1,ml:19.5,minWidth: 290 }}>
                                                            ...
                                                            <Select
                                                                ...
                                                                name="pharma_id"
                                                                type="text"
                                                                value={permitNotVerifiedInput.pharma_id}
                                                                onChange={handleInput}
                                                                label="Pharmacist"
                                                                color="warning"
                                                                margin="normal"
                                                        ...
                                                        {/* <span className="text-danger">{permitNotVerifiedInput.error_list.pharma_id}</span> */}
                                                    </FormControl>
                                                    ...
                                                    <FormControl variant="standard" sx={{ mt:4,ml:19.5,minWidth:290 }}>
                                                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                                                ...
                                                                {/* <span className="text-danger">{permitNotVerifiedInput.error_list.permit_date}</span> */}
                                                    ...
                                                    <FormControl variant="standard" sx={{mt:9,ml:19.5,minWidth: 290 }}>
                                                            ...
                                                            <Select
                                                                ...
                                                                name="poe_id"
                                                                type="text"
                                                                value={permitNotVerifiedInput.poe_id}
                                                                onChange={handleInput}
                                                        ...
                                                        {/* <span className="text-danger">{permitNotVerifiedInput.error_list.poe_id}</span> */}
                                                    </FormControl>
                            ...
                            <Link style={{ textDecoration: 'none' }} to="/admin/view-permit-not-verified" >
                                <Button
                                    type="reset"
                                    fullWidth
                                    variant="contained"
                    ...
                    <Button
                        ...
                        <Button
                            ...
                            onClick={(e)=>submitPermitForApproval(e)}
                        >
                            Submit for approval
                        </Button>
                </div>
