...
qty: {
    ...
    var permit_report="";
    if (loading) {
        return <h4>Loading work plan report...</h4>
    }
    else
    {
            ...
            <Page size="A4" style={styles.page}>
                    ...
                    <Fragment>
                        <View style={styles.invoiceNoContainer}>
                            ...
                            <Text style={styles.invoiceDate}>{permit.permit_no}</Text>
                        </View >
                        <View style={styles.invoiceDateContainer}>
                            <Text style={styles.label}>Date: </Text>
                            <Text >{permit.permit_date}</Text>
                        </View >
                    </Fragment>
                
                    <View style={styles.headerContainer}>
                        <Text style={styles.billTo}>Company</Text>
                        <Text>{permit.company.comp_name}</Text>
                    ...
                    <View style={styles.tableContainer}>
                        ...
                        <View style={styles.row2} >
                            ...
                            <Text style={styles.qty}>{permit.check_digit}</Text>
                            
                            <Text style={styles.qty}>{permit.supplier.company_name}</Text>
                            
                            <Text style={styles.qty}>  {permit.pharmacist.first_name+" "+permit.pharmacist.last_name}</Text>
                            <Text style={styles.qty}>{permit.valid_from}</Text>

                            <Text style={styles.qty}>{permit.valid_to}</Text>

                            <Text style={styles.qty}>{permit.points_of_entry_exit.name}</Text>
                           
                            <Text style={styles.qty}>{permit.purpose_use}</Text>

                            <Text style={styles.qty}>{permit.permit_status}</Text>

                            <Text style={styles.qty}>{permit.company.comp_name}</Text>

                            <Text style={styles.qty}>{permit.id}</Text>
                        </View>
                        </Fragment>
                    </View>
                </Page>
