...
function ViewSchedule() {
    ...
    var viewSchedule_HTMLTABLE="";
    var a=1;

    if (loading) {
        return <h4>Loading View Schedule...</h4>
    }
    else
    {
        viewSchedule_HTMLTABLE=
        <div>
                ...
                >
                    <TableHead>
                        <TableRow>
                                ...
                                <TableCell sx={{color:'white',fontWeight:'bold',backgroundColor:'#00022E'}}>Name</TableCell>
                    ...
                    <TableBody>
                            ...
                            {
                                return schedule;
                            } else if ( schedule.name.toLowerCase().includes(query.toLowerCase()) ) {
                                return schedule;
                            }
                            }).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((schedule, index) => (  
                                <TableRow
                                    key={schedule.id}
                                ...
                                >
                                        ...
                                        <TableCell sx={{fontWeight:'bold',color:'#00022E'}}>{schedule.name}</TableCell>
                                        
                                        <TableCell>
                                            <Link style={{textDecoration:'none'}} to={`edit-schedule/${schedule.id}`}>
                                                    <Button
                                                        size="small"
                                                        type="button"
                                                        fullWidth
        ...
        <div className="container px-4">
            <div className="card mt-4">
                <div className="card-header   bg-danger">
                    <h4 className="text-white"> Schedule list
